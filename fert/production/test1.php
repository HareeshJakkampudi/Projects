...
<?php
$a = date('Y-m-d',strtotime($_REQUEST['a']));
$b = date('Y-m-d',strtotime($_REQUEST['b']));
$c = $_REQUEST['c'];
$g = $_REQUEST['g'];
...
if (!$con) {
 ...
 $sql="SELECT * FROM `create_grn` WHERE date1 BETWEEN '$a'and '$b' and farmer_id='$c' and product_id='$g'";
