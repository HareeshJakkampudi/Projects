   ...
   if(isset($_POST['submit']))
       {
        ...
        $vname     = $_POST['vname'];
        $adds      = $_POST['address'];
        $lddetails = $_POST['lddetails'];
        $rate      = $_POST['rate'];
       echo"<script>alert('$adds')</script>";
        $sql = "INSERT INTO `product`(`name`,`code`,`units`,`rate1`,`vendorname`,`address`,`latest_d_d`)VALUES('$pdname','$code','$unm','$rate','$vname','$adds','$lddetails')";
        if(mysqli_query($con,$sql))
        {
          echo"<script>alert('inserted');window.location.href = 'product.php';
 </script>";
        }else{
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                 ...
                 <div class="x_content">
                    <br />
                       <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POSt" action="product.php">
                        <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="">Product Name <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="pdname" required="required" class="form-control col-md-7 col-xs-12" placeholder="eg:xxxx">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Units Of Measurment <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="" name="units" required="required" class="form-control col-md-7 col-xs-12" maxlength="10"  placeholder=" Number"  >
                        </div>
                      </div>
                     
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Latest Delivery Details<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="" name="lddetails" required="required" class="form-control col-md-7 col-xs-12" maxlength="5"  placeholder=""  >
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="" class="control-label col-md-3 col-sm-3 col-xs-12">Rate</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="" class="form-control col-md-7 col-xs-12" type="text" name="rate">
                        </div>
                      </div>
                      s
