<?php
  include("db.php");
    ...
    if(isset($_POST['submit']))
    {
        ...
        $sql  ="INSERT INTO `raw_mp`(`date1`,`product_name`,`vendor_id`,`vehicleno`,`driver_name`,`driver_no`,`wayment_no`,`no_bags`,`gross_kgs`,`tare_kgs`,`net_kgs`)VALUES('$date','$pdname','$vendor','$vno','$drname','$drno','$wrno','$no_bags','$gkgs','$tkgs','$nkgs')";
        if(mysqli_query($con,$sql))
        {
          echo "<script>alert('data Inserted');  window.location.href='rawm';</script>";
              
        }
        else{
        
          echo "<script>alert('check once wayment Number,Same Wayment Number exist in database')window.location.href='rawm';;</script>";
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title ">
                 ...
                 <div class="x_content">
                    <br />
                    <form id="demo-form2" name="f1" class="form-horizontal form-label-left" method="POST" action="rawm.php">
                       <div class="col-md-4 col-sm-4 col-xs-12 form-group form-label-top ">
                        ...
                        <div class='input-group date' id='myDatepicker'>
                          ...
                          <span class="input-group-addon  ">
                             <span class=""><i class="fas fa-calendar-alt" aria-hidden="true"></i></span>
                          </span>
                        </div>
                         </div>
                        <div class="col-md-4 col-sm-4 col-xs-12 form-group form-label-top">
