  ...
  //ini_set( "display_errors", 0); 
   ...
   $sql  ="INSERT INTO `create_grn`(`date1`,`farmer_id`,`product_id`,`vehicle_no`,`driver_name`,`driver_no`,`wayment_no`,`moisture`,`gross_kgs`,`tare_kgs`,`net_kgs`,`grn_id`)VALUES('$date','$Farmer_ID','$Product_ID','$Vehicle_NO','$driver_name','$driver_NO','$waymentrno','$Moisture','$Gross_kgs','$Tare_kgs','$Net_kgs','$grn_id')";
        if(mysqli_query($con,$sql))
        {
          ...
          echo mysqli_error($con).$s;//"<script>alert('check your input details');window.location.href='creategrn'</script>";
    ...
    <div class="container body">
          ...
          <div class="profile clearfix">
            ...
            <div class="profile_info">
              <span>WELCOME</span>
                 ...
                 <li><a href=""><i class="fa fa-table"></i> HOME <span class="fa fa-chevron-down"></span></a>
                </li>
     ...
     <div class="right_col" role="main">
        <div class="">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                 ...
                 <div class="x_content">
                    <br />
             <form id="demo-form2" name="f1" class="form-horizontal form-label-left" method="POST" action="creategrn.php">
         ...
         <div class=' input-group date' id='myDatepicker'>
           ...
           <span class="input-group-addon md-2 ">
              <span class="fixed"><i class="fa fa-calendar" aria-hidden="true"></i></span>
           </span>
         </div>
          </div>
         <div class=" item col-md-4 col-sm-4 col-xs-12 form-group form-label-top">
         ...
         <input type="text" class="form-control " name="Farmer_ID" placeholder="Enter Vendor ID" >
       </div>
          <div class=" item col-md-4 col-sm-4 col-xs-12 form-group form-label-top">
             <label class="control-label " for="">Product_ID <span class="required">*</span>
         </label>
         <input type="text" class="form-control" name="Product_ID" id="inputSuccess2" placeholder="Enter Product Name" >
         </div>
         ...
         <div class="ln_solid"></div>
		  <p>
                 <button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample" id="hide1">
       ...
       <div class="form-group">
         ...
         <div class="col-md-6 col-sm-6 col-xs-12">
           <input type="phonenumber" id="" name="driverno" required="required" class="form-control col-md-7 col-xs-12" maxlength="10"  placeholder="Enter Phone Number"  >
         </div>
       </div>
				  </div>
		    </div>
       ...
       <div class="form-group">
         ...
         <div class="col-md-6 col-sm-6 col-xs-12">
           <input id="c" class="form-control col-md-7 col-xs-12" type="text" name="netkgs" readonly="readonly" onclick="loadXMLDoc();">
         </div>
       </div>
	  </div>
	  </div>
...
<button class="btn btn-primary pull-left" type="reset">ClearForm</button>
           <button type="submit" class="btn btn-success pull-right" name="submit" id="hs">Submit</button>
            <button class="btn btn-danger pull-right" id="hide">Hide</button>
            <button class="btn btn-danger pull-right" id="show">Show</button>
         </div>
       </div>
