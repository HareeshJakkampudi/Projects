            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title ">
                 ...
                 <div class="x_content">
                    <br />
                     <form id="demo-form2" class="form-horizontal form-label-left" method="POST" action="approve_GRN">
                                   <div class=" item col-md-6 col-sm-6 col-xs-12 form-group form-label-top ">
                               <label class="control-label" for=""> From   </label>
                        <div class=' input-group date' id='myDatepicker'>
                          <input type='text' class="form-control" placeholder="DD.MM.YYYY"  name="date" onblur="showHint(this.value)" id="a">
                        ...
                        <tbody>
                          <?php
                             ...
                             if(isset($_POST['submit']))
                            {
                              ...
                              $farmer =$_POST['vendor'];
                              $sql ="SELECT * FROM `create_grn` WHERE farmer_id ='$farmer' OR product_id ='$product' or date1 BETWEEN '$date' AND '$date1'";
                            ...
                            ?>    
                                  <tr>
                                      ...
                                      <td><a href="#" class="badge badge-pill bg-red"  ><?php echo $row['status'];  ?></a></td>
                                        <?php } else  {?>
                                            <td><a href="#" class="badge badge-pill bg-green"  data-toggle="modal" data-target="#modalCart"><?php echo $row['status'];  ?></a></td>
                                        <?php } ?>
                ...
                <form role="form">
                  ...
                  <div class="form-group">
                    <label for="VENDOR_ID">Vendor ID</label>
                      <input type="text" class="form-control"
                          id="" placeholder="Vendor_ID"/>
                  </div>
                  <div class="form-group">
                    <label for="product_ID">product ID</label>
                      <input type="text" class="form-control"
                          id="" placeholder="product_ID"/>
                  </div>
                  <div class="checkbox">
                    <label>
                        <input type="checkbox"/> Approve Now
                    </label>
                  </div>
                  <button type="button" id="msub"class="btn btn-default" onclick="myfunction()">Submit</button>
                </form>
                <script>
                  function myfunction(){
                    $("#msub").attr("data-dismiss","modal");
                  }
                </script>
