 ...
 if($result12){
   ...
   while($row=mysqli_fetch_array($result))
   {
    ...
    if(isset($_POST['submit'])){
      ...
      $result2=mysqli_query($conn,"INSERT INTO `faculty`(`faculty`, `month`) VALUES ('$fname','01')");
      $result3=mysqli_query($conn,"INSERT INTO `faculty`(`faculty`, `month`) VALUES ('$fname','02')");
      $result4=mysqli_query($conn,"INSERT INTO `faculty`(`faculty`, `month`) VALUES ('$fname','03')");
      $result5=mysqli_query($conn,"INSERT INTO `faculty`(`faculty`, `month`) VALUES ('$fname','04')");
      $result6=mysqli_query($conn,"INSERT INTO `login`(`name`, `username`,`password`) VALUES ('$fname','$usr','$pas')");
            ...
            <aside class="main-sidebar hidden-print ">
                <section class="sidebar" id="sidebar-scroll">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="active treeview"><a class="waves-effect waves-dark" href="#!"><i class="icon-book-open"></i><span> Faculty Details</span><i class="icon-arrow-down"></i></a>
                            <ul class="treeview-menu">
                                <li><a href="faculty_daily.php" class="waves-effect waves-dark"><i class="icon-arrow-right"></i> Faculty Daily Analysis</a></li>
                                <li><a href="faculty_monthly.php"><i class="icon-arrow-right"></i>Faculty Monthly Analysis</a></li>
                                <li class="active"><a href="add_faculty.php" class="waves-effect waves-dark"><i class="icon-arrow-right"></i>Add Faculty</a></li>
                            </ul>
                        </li>
            ...
            <div class="panel panel-body">
                <div class="col-md-12 ">
                    ...
                    <form action="" method="post">
                        <label>Name</label>
                        <input type="text" name="faculty" placeholder="Enter Name">
                        <label>User Name</label>
                        <input type="text" name="username" placeholder="Enter User Name">
                        <label>Password</label>
                        <input type="password" name="pass" placeholder="Enter Password">
                        <input type="submit" name="submit" value="add" class="btn btn-success btn-md">
                    ...
                    <table class="table table-striped">
                        ...
                        <?php 
			  $result=mysqli_query($conn,"select distinct faculty from faculty where month='$m' order by faculty DESC");
			  $serialnumber=0;
			 if($result){
			  ...
			  ?>
                        <tr>
                            ...
                            <td>
                                <a href="sample.php?name=<?php echo $row['faculty']; ?>" target="_blank">
