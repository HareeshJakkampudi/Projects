                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="active treeview"><a class="waves-effect waves-dark" href="#!"><i class="icon-book-open"></i><span> Faculty Details</span><i class="icon-arrow-down"></i></a>
                            <ul class="treeview-menu">
                                ...
                                <li class="active"><a href="faculty_monthly.php" class="waves-effect waves-dark"><i class="icon-arrow-right"></i>Faculty Monthly Analysis</a></li>
                        ...
                        <li class="treeview"><a class="waves-effect waves-dark" href="#!"><i class="icon-chart"></i><span> Charts</span><i class="icon-arrow-down"></i></a>
                            <ul class="treeview-menu">
                               <li><a class="waves-effect waves-dark" href="student_chart.php"><i class="icon-arrow-right"></i> Student Charts</a></li>
                            <li><a class="waves-effect waves-dark" href="faculy_chart.php"><i class="icon-arrow-right"></i>Faculty Charts</a></li>
                            ...
                            <div class="table-wrapper-2">
                                <div class="content ">
                                    <table class="table table-striped">
                                        ...
                                        <?php
                                       $result=mysqli_query($conn,"select distinct `f_name` from faculty_status where `month`='$m'");
                                        if($result){
                                            $serialnumber=0;
                                            while($row=mysqli_fetch_array($result))
                                            {
