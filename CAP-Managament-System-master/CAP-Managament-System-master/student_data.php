                ...
                <section class="sidebar" id="sidebar-scroll">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="active treeview"><a class="waves-effect waves-dark" href="#!"><i class="icon-chart"></i><span> Charts</span><i class="icon-arrow-down"></i></a>
                            <ul class="treeview-menu">
                               <li  class="active"><a class="waves-effect waves-dark" href="student_data.php"><i class="icon-arrow-right"></i> Student Charts</a></li>
                            ...
                            <div class="table-wrapper-2">
                                <div class="content ">
                                    <table class="table table-striped">
                                      ...
                                      <td>
                                         <a href="student_chart.php?name=<?php echo $s_name; ?>" target="_blank">
                                                        <?php echo $s_name;?>
                                                
                                                        </a>
                                        </td>
                                                    <td>
                                                        <?php echo $row['points_j'];?>
                                                        
                                                    </td>
                                                    <td>
                                                        <?php echo $row['points_f'];?>
                                                    </td>
                                                    <td>
                                                        <?php echo $row['points_m'];?>
                                                    </td>
                                                    <td>
                                                        <?php echo $row['points_a'];?>
                                                    </td>
