        ...
        <div class="wrapper">
                ...
                <section class="sidebar" id="sidebar-scroll">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="active treeview"><a class="waves-effect waves-dark" href="#!"><i class="icon-book-open"></i><span> Faculty Details</span><i class="icon-arrow-down"></i></a>
                            <ul class="treeview-menu">
                                <li class="active"><a href="faculty_daily.php" target="_blank" class="waves-effect waves-dark"><i class="icon-arrow-right"></i> Faculty Daily Analysis</a></li>
            ...
            <div class="panel panel-success">
                ...
                <div class=" panel-heading">
                    <h3 class="panel-title">DateWise Analysis</h3>
                </div>
                            ...
                            <div class="table-wrapper-2">
                                <div class="content">
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <?php 
              $result=mysqli_query($conn,"select distinct date from faculty_status where month='$m' order by date DESC");
              $serialnumber=0;
              while($row=mysqli_fetch_array($result))
              {
                $serialnumber++;
              ...
              ?>
                                        <tbody>
                                            <tr style="font-size:15px">
                                                ...
                                                <td>
                                                    <form method="post" action="show_faculty.php" target="_blank">
                                                        <input type="hidden" name="date" value="<?php echo $row['date']; ?>">
                                                     
                                                     
                                                        <input type="submit" name="submit" value="Open" class="btn btn-info btn-fill">
